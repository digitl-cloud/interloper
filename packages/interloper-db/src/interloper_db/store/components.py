...
class ComponentStore:
    ...
    def discriminator(self, db_component: Component) -> str | None:
        ...
        What tells an instance apart from others of its class (an ad account
        id, a site URL): it suffixes a source's physical table names, and it
        is the identifier a user holds when they come from the warehouse or
        the vendor rather than from the display name, so every response
        discloses it, list and detail alike.

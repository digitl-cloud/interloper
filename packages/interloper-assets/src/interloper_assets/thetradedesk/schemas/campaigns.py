...
class Campaigns(Schema):
    """The Trade Desk campaign performance metrics."""
    ...
    campaign_start_date: dt.date | None = Field(default=None, description="Campaign start date")
    campaign_end_date: dt.date | None = Field(default=None, description="Campaign end date")
    campaign_budget: float | None = Field(default=None, description="Campaign budget")
    campaign_daily_budget: float | None = Field(default=None, description="Campaign daily budget")

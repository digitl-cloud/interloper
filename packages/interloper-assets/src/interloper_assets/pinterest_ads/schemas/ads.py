...
class Ads(Schema):
    """Pinterest Ads performance report with engagement, cost, and conversion metrics."""

    date: dt.date = Field(description="Date of the data")
    # Identifiers
    ad_group_id: str = Field(description="Identifier for the ad group")
    ...
    campaign_managed_status: int = Field(description="Status of campaign management")
    ...
    earned_ctr: float = Field(description="Click-through rate on earned impressions")
    ...
    # Engagement metrics
    earned_engagements: int = Field(description="Number of engagements earned")
    earned_impressions: int = Field(description="Number of impressions earned")
    earned_outbound_clicks: int = Field(description="Number of outbound clicks earned")
    earned_pin_clicks: int = Field(description="Number of pin clicks earned")
    earned_saves: int = Field(description="Number of saves earned")
    engagement_rate: float = Field(description="Rate of engagements")
    engagement_rate_1: float = Field(description="Another rate of engagements")
    ...
    click_through_conversions_add_to_cart: int = Field(
        description="Number of conversions from clicks leading to adding items to cart"
    )
    click_through_conversions_app_install: int = Field(
        description="Number of conversions from clicks leading to app installations"
    )
    click_through_conversions_category_view: int = Field(
        description="Number of conversions from clicks leading to category views"
    )
    click_through_conversions_checkout: int = Field(
        description="Number of conversions from clicks leading to checkouts"
    )
    click_through_conversions_custom: int = Field(
        description="Number of conversions from custom actions after a click"
    )
    click_through_conversions_lead: int = Field(
        description="Number of conversions from clicks leading to generating leads"
    )
    click_through_conversions_page_visit: int = Field(
        description="Number of conversions from clicks leading to page visits"
    )
    click_through_conversions_signup: int = Field(
        description="Number of conversions from clicks leading to signups"
    )
    click_through_conversions_unknown: int = Field(
        description="Number of conversions from unknown actions after a click"
    )
    click_through_conversions_watch_video: int = Field(
        description="Number of conversions from clicks leading to watching videos"
    )
    click_through_conversions_website_search: int = Field(
        description="Number of conversions from clicks leading to website searches"
    )
    # Engagement conversions
    engagement_conversions_add_to_cart: int = Field(
        description="Number of conversions from engagements leading to adding items to cart"
    )
    engagement_conversions_app_install: int = Field(
        description="Number of conversions from engagements leading to app installations"
    )
    engagement_conversions_category_view: int = Field(
        description="Number of conversions from engagements leading to category views"
    )
    engagement_conversions_checkout: int = Field(
        description="Number of conversions from engagements leading to checkouts"
    )
    engagement_conversions_custom: int = Field(
        description="Number of conversions from custom engagements"
    )
    engagement_conversions_lead: int = Field(
        description="Number of conversions from engagements leading to generating leads"
    )
    engagement_conversions_page_visit: int = Field(
        description="Number of conversions from engagements leading to page visits"
    )
    engagement_conversions_signup: int = Field(
        description="Number of conversions from engagements leading to signups"
    )
    engagement_conversions_unknown: int = Field(
        description="Number of conversions from unknown engagements"
    )
    engagement_conversions_watch_video: int = Field(
        description="Number of conversions from engagements leading to watching videos"
    )
    engagement_conversions_website_search: int = Field(
        description="Number of conversions from engagements leading to website searches"
    )
    # View-through conversions
    view_through_conversions_add_to_cart: int = Field(
        description="Number of view-through conversions resulting in adding items to cart"
    )
    view_through_conversions_app_install: int = Field(
        description="Number of view-through conversions resulting in app installations"
    )
    view_through_conversions_category_view: int = Field(
        description="Number of view-through conversions resulting in category views"
    )
    view_through_conversions_checkout: int = Field(
        description="Number of view-through conversions resulting in checkouts"
    )
    view_through_conversions_custom: int = Field(
        description="Number of view-through conversions from custom actions"
    )
    view_through_conversions_lead: int = Field(
        description="Number of view-through conversions resulting in generating leads"
    )
    view_through_conversions_page_visit: int = Field(
        description="Number of view-through conversions resulting in page visits"
    )
    view_through_conversions_signup: int = Field(
        description="Number of view-through conversions resulting in signups"
    )
    view_through_conversions_unknown: int = Field(
        description="Number of view-through conversions from unknown actions"
    )
    view_through_conversions_watch_video: int = Field(
        description="Number of view-through conversions resulting in watching videos"
    )
    view_through_conversions_website_search: int = Field(
        description="Number of view-through conversions resulting in website searches"
    )
    # Totals
    ...
    organic_pin_id: str = Field(description="Identifier for the organic pin")
    pin_clicks: int = Field(description="Total number of pin clicks")
    pin_promotion_status: str = Field(description="Status of pin promotion")
    ...
    spend_in_account_currency: float = Field(description="Spend in the account's currency")
    # Paid metrics
    paid_ctr: float = Field(description="Click-through rate for paid engagements")
    ...
    paid_save_rate: float = Field(description="Rate of paid saves")

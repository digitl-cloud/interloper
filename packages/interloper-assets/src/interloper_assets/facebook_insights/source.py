...
from interloper_assets.facebook_insights.schemas import PageInsights, PostInsights
...
class FacebookInsights(il.Source):
    ...
    def page_insights(
        ...
        return fake_data(PageInsights, partition_column="date", partition_date=context.partition_date)
    ...
    def post_insights(
        ...
        return fake_data(PostInsights, partition_column="date", partition_date=context.partition_date)

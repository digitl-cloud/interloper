...
# Minimum amount of time between polling requests (seconds). Defaults to 1 minute.
MIN_RETRY_INTERVAL = 60
# Maximum amount of time between polling requests (seconds). Defaults to 20 minutes.
...
DIMENSIONS = [
    ...
    "FILTER_campaign_manager_360_PLACEMENT_ID",
    "FILTER_CREATIVE_ID",

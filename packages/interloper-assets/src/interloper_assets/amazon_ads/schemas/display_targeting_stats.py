...
class DisplayTargetingStats(Schema):
    """Display targeting performance metrics including clicks, impressions, and targeting expression details."""
    ...
    add_to_cart_clicks: int | None = Field(..., description="The number of clicks for add to cart")
    add_to_cart_rate: float | None = Field(..., description="The rate of add to cart")
    add_to_cart_views: int | None = Field(..., description="The number of add to cart views")
    ...
    branded_searches_clicks: int | None = Field(..., description="The number of clicks for branded searches")
    branded_searches_views: int | None = Field(..., description="The number of views for branded searches")
    ...
    detail_page_views_clicks: int | None = Field(..., description="The number of clicks for detail page views")
    ...
    impressions_views: int | None = Field(..., description="The number of views for impressions")
    new_to_brand_detail_page_view_clicks: int | None = Field(
    ...
    new_to_brand_detail_page_view_views: int | None = Field(
    ...
    new_to_brand_units_sold: int | None = Field(..., description="The number of units sold for new-to-brand")
    ...
    purchases_clicks: int | None = Field(..., description="The number of clicks for purchases")
    purchases_promoted_clicks: int | None = Field(..., description="The number of clicks for purchases promoted")
    ...
    units_sold_clicks: int | None = Field(..., description="The number of clicks for units sold")
    video_complete_views: int | None = Field(..., description="The number of complete video views")
    video_first_quartile_views: int | None = Field(..., description="The number of views for video first quartile")
    video_midpoint_views: int | None = Field(..., description="The number of views for video midpoint")
    video_third_quartile_views: int | None = Field(..., description="The number of views for video third quartile")

...
class BrandsAdsStats(Schema):
    """Brands individual ad performance metrics including impressions, clicks, conversions, and new-to-brand metrics."""
    ...
    add_to_cart: int | None = Field(..., description="The number of items added to cart")
    add_to_cart_clicks: int | None = Field(..., description="The number of clicks resulting in adding to cart")
    add_to_cart_rate: float | None = Field(..., description="The rate of adding to cart")
    branded_searches: int | None = Field(..., description="The number of searches for the brand")
    branded_searches_clicks: int | None = Field(
    ...
    clicks: int | None = Field(..., description="The number of ad clicks")
    ...
    detail_page_views: int | None = Field(..., description="The number of views of the ad's detail page")
    detail_page_views_clicks: int | None = Field(
    ...
    impressions: int | None = Field(..., description="The number of ad impressions")
    ...
    new_to_brand_purchases: int | None = Field(..., description="The number of purchases from new-to-brand customers")
    new_to_brand_purchases_clicks: int | None = Field(
    ...
    new_to_brand_units_sold: int | None = Field(
    ...
    purchases_clicks: int | None = Field(..., description="The number of clicks resulting in purchases")
    ...
    units_sold_clicks: int | None = Field(..., description="The number of clicks resulting in units sold")
    video_5_second_view_rate: float | None = Field(..., description="The rate of 5-second views of video ads")
    video_5_second_views: int | None = Field(..., description="The number of 5-second views of video ads")
    video_complete_views: int | None = Field(..., description="The number of complete views of video ads")
    video_first_quartile_views: int | None = Field(..., description="The number of first quartile views of video ads")
    video_midpoint_views: int | None = Field(..., description="The number of midpoint views of video ads")
    video_third_quartile_views: int | None = Field(..., description="The number of third quartile views of video ads")
    video_unmutes: int | None = Field(..., description="The number of unmutes of video ads")
    viewability_rate: float | None = Field(..., description="The rate of ad viewability")
    viewable_impressions: int | None = Field(..., description="The number of viewable ad impressions")

...
class ProductsTargetingStats(Schema):
    ...
    units_sold_clicks_14d: int | None = Field(..., description="The units sold for clicks within 14 days")
    units_sold_clicks_1d: int | None = Field(..., description="The units sold for clicks within 1 day")
    units_sold_clicks_30d: int | None = Field(..., description="The units sold for clicks within 30 days")
    units_sold_clicks_7d: int | None = Field(..., description="The units sold for clicks within 7 days")
    units_sold_other_sku_7d: int | None = Field(..., description="The units sold for other SKUs within 7 days")

...
class DisplayAdvertisedProductsStats(Schema):
    """Display advertised product performance metrics including clicks, impressions, purchases, and viewability."""
    ...
    branded_searches_views: int | None = Field(..., description="The number of branded searches views")
    ...
    cumulative_reach: int | None = Field(..., description="The cumulative reach")
    ...
    impressions_views: int | None = Field(..., description="The number of impressions views")
    ...
    purchases_promoted_clicks: int | None = Field(..., description="The number of purchases promoted clicks")
    ...
    video_complete_views: int | None = Field(..., description="The number of video complete views")

...
class Campaigns(itlp.AssetSchema):
    """
    The Criteo Campaigns report provides insights into the effectiveness of advertising campaigns across multiple channels and attribution models.
    It includes key metrics such as campaign performance indicators such as total revenue generated, cost per acquisition, click-through rate, conversion rate, and audience reach.
    """
    ...
    campaign_id: int = field(metadata={"description": "The unique identifier for the campaign"})

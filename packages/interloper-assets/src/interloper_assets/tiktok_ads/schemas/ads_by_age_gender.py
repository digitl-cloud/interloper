...
class AdsByAgeGender(Schema):
    """Ad performance report segmented by age and gender demographics."""
    ...
    age: str = Field(description="Age group of the target audience")
    gender: str = Field(description="Gender of the target audience")

...
class Component(Serializable):
    ...
    def discriminator_field(cls) -> str | None:
        ...
        Lets a caller holding a component's config read the discriminator
        without constructing the instance: the persistence layer discloses it
        on every stored row, however incomplete or stale the config.
